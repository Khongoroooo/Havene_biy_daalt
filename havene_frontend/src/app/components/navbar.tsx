                ...
                <div className="w-full md:w-1/2 p-8">
                  {view === "login" && (
                    <>
                      ...
                      <InputField type="email" placeholder="E-mail" icon={Mail} />
                      ...
                      <div className="mt-3">
                        <Button label="SIGN UP" variant="secondary" onClick={() => setView("signup")} />
                      </div>
                    </>
                  )}
                  ...
                  {view === "forgot" && (
                    <>
                      ...
                      <Button label="RESET PASSWORD" onClick={() => setView("verify")} />
                      <div
                        className="mt-4 text-sm text-gray-500 w-full text-center cursor-pointer hover:underline"
                        onClick={() => setView("login")}
                      >
                  ...
                  {view === "verify" && (
                    <>
                      <h2 className="text-center text-xl font-semibold mb-6">VERIFY CODE</h2>
